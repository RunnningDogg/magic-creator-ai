  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-6">
      <h1 className="mb-10 mt-3   text-3xl font-bold">
        Privacy Policy for GPTs-store
      </h1>

      <p>
        At GPTs-store, accessible from https://gpts-store.net/, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        GPTs-store and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in GPTs-store. This policy is not applicable to
        any information collected offline or via channels other than this
        website.
      </p>

      <h2 className="mb-2 text-2xl font-semibold">Consent</h2>
      ...
      <h2 className="mb-2 text-2xl font-semibold">Log Files</h2>

      <p>
        GPTs-store follows a standard procedure of using log files. These files
      ...
      <p>
        ...
        advertising partners of GPTs-store.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on GPTs-store, which are sent
      ...
      <p>
        Note that GPTs-store has no access to or control over these cookies that
      ...
      <p>
        GPTs-store&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        GPTs-store does not knowingly collect any Personal Identifiable
